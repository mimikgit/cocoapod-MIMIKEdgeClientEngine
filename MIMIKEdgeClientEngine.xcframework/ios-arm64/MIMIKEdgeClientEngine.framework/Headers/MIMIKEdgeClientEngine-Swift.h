...
#ifndef MIMIKEDGECLIENTENGINE_SWIFT_H
#define MIMIKEDGECLIENTENGINE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MIMIKEdgeClientEngine",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif



SWIFT_CLASS("_TtC21MIMIKEdgeClientEngine25MIMIKEdgeClientEdgeEngine")
@interface MIMIKEdgeClientEdgeEngine : NSObject
...
SWIFT_CLASS("_TtC21MIMIKEdgeClientEngine9MIMIKNode")
...
///
SWIFT_CLASS("_TtC21MIMIKEdgeClientEngine22MIMIKStartupParameters")
